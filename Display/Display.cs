 ...
 *                 DBFactory.cs, UtilityExtensions.cs
 *
 ...
 * --------------------
 * ver 1.3 : 07 Oct 15
 * - minor decorations/tweaks to show functions
 * ver 1.2 : 24 Sep 15
...
namespace NoSqlDB
{
   ...
   */
    public static class DisplayExtensions
    {
        ...
        public static void showDB(this DBEngine<string, DBElement<string, string>> db)
        {
            WriteLine();
            "  DB contents".title2();
        ...
        public static void showDB(this DBFactory<string, DBElement<string, string>> db)
        {
            WriteLine();
            "  DB contents".title2();
            db.show<string, DBElement<string, string>, string>();
